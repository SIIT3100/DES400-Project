const SIDEBAR_LINK = [
  {
    heading: "OVERVIEW",
    links: [
      { link: "/dashboard", text: "System Overview" },
      ...
      { link: "/", text: "PIR Sensor Maps" },
    ],
  },
  {
    heading: "CONTROL",
    links: [
      { link: "/per-device-control", text: "Per Device Control" },
  ...
  },
  {
    ...
    links: [
      { link: "/device-connection", text: "Gateway Status" },
...
function sidebar_division(sidebar_heading, sidebar_links) {
  let sidebar_div = `<h6 class = "sidebar-heading d-flex justify-content-between align-items-center px-3 mt-3 text-muted">
